...
@click.command()
@click.option('--band', required=True, type=int, help='Raster band to process.')
@click.option('--year', required=True, type=int, help='Year of the data to process.')
@click.option('--shapefile', required=True, type=click.Path(exists=True), help='Path to the shapefile.')
@click.option('--id_field', required=True, type=str, help='Attribute field in shapefile for zonal comparison')
